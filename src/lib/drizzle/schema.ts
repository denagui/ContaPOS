...
export const journalEntries = sqliteTable('journal_entries', {
  ...
  reversedBy: text('reversed_by').references((): any => journalEntries.id),
...
export const journalLines = sqliteTable('journal_lines', {
  id: text('id').primaryKey(),
  journalEntryId: text('journal_entry_id').notNull().references((): any => journalEntries.id, { onDelete: 'cascade' }),
  lineNumber: integer('line_number').notNull(),
  accountId: text('account_id').notNull().references((): any => chartOfAccounts.id),
  description: text('description'),
